...
function Articles() {
  ...
  const articles = {
    blogs: [
      {
        id: 1,
        title: "Training an Agent to Play Breakout using Deep Reinforcement Learning",
        description: "Walkthrough of implementing Deep Q-Networks to train an agent on Atari Breakout: architecture, replay, and training details.",
        date: "April 23, 2025",
        link: "https://medium.com/@simeetnayan81/training-an-agent-to-play-breakout-using-deep-reinforcement-learning-b5ca02c81182",
      },
      {
        id: 2,
        title: "Deriving Naive Bayes from scratch",
        description: "A first-principles derivation of Naive Bayes, from Bayes' rule through the independence assumption to the decision rule.",
        date: "July 17, 2021",
    ...
    papers: [
      {
        ...
        description: "Classical ML pipeline for brain-tumor classification on 2D MRI: GLCM, 2D-DWT, and histogram features, PCA for dimensionality reduction, and a comparison of Gaussian Naïve Bayes, Random Forest, XGBoost, and SVC. SVC reached 98% accuracy.",
        journal: "IEEE",
        date: "January 2025",
